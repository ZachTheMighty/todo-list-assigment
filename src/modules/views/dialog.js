...
export const descriptionTextArea = document.createElement("textarea");
...
export const prioritySelect = document.createElement("select");
...
export const notesInput = document.createElement("input");
